...
public class FuncionTest {
	...
	public void fibonacciDe0() {
		int resultado = Funciones.fibonacciDeUnNumero(0);
		Assert.assertEquals(0, resultado);
	}

	@Test
	public void fibonacciDe1() {
		int resultado = Funciones.fibonacciDeUnNumero(1);
		Assert.assertEquals(1, resultado);
	}

	@Test
	public void fibonacciDe2() {
		int resultado = Funciones.fibonacciDeUnNumero(2);
		Assert.assertEquals(1, resultado);
	}

	@Test
	public void fibonacciDe8() {
		int resultado = Funciones.fibonacciDeUnNumero(8);

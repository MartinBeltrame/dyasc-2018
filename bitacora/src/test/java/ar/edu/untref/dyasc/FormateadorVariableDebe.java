...
public class FormateadorVariableDebe {

	@Test
	public void devolver_solo_el_nombre_del_archivo_cuando_el_tipo_de_argumento_es_archivo() {

		String obtenido = FormateadorVariable.obtenerVariableDestino("bitacora.destino=bitacora.txt");
	...
	public void devolver_solo_el_nombre_del_archivo_txt_cuando_el_tipo_de_argumento_es_archivo_consola() {
		...
		String obtenido = FormateadorVariable.obtenerVariableDestino("bitacora.destino=bitacora.txt,CONSOLA");
